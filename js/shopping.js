				...
				if(!cartStr) {
					...
					for(var id in cartObj) {
						...
						var str = '<ul class="goodInfo" data-good-id="' + id + '">' +
							'<li class="good1"><img src="' + good.src + '" /></li>' +
							'<li class="good2">' + good.name + '</li>' +
							'<li class="good3">￥' + good.price + '</li>' +
							'<li class="num">' +
							'<a href="javascript:;" class="minus">-</a>' +
							' <input type="text" value="' + good.num + '" />  ' +
							'<a href="javascript:;" class="plus">+</a>' +
							'</li>' +
							'<li class="total" id="good5">￥' + good.num * good.price + '</li>' +
							'<li class="good6"><a href="javascript:;" class="del">删除</a></li>' +
							'</ul>';
							
						//将上面的结构添加到cartList中去
						$(str).appendTo(".shop-extra");
						var strNum='<span>'+ good.num * good.price +'</span>';
						
						$(strNum).appendTo(".product-price span strong");
						console.log(str)
					}
